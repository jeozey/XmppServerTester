...
public class ComplianceTester {
    ...
    public static void main(String[] args) {
        Jid jid = Jid.of("jeozey2016@conversations.im");
        jid = Jid.of("000001@192.168.211.166");
...
//            password = args[1];
    ...
    private static void runTestSuite(Class <? extends AbstractTestSuite> clazz, Jid jid, String password, boolean rerun) {
         try {
            try {
                AbstractTestSuite testSuite = TestSuiteFactory.create(clazz, jid, password,"192.168.211.166",5222);
